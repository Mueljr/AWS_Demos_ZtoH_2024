The project as in this folder involves the implementation of the **AWS Elastic Container Service (ECS)** resource to deploy a **simple Python Flask web application.**
